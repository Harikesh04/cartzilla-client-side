...
function BottomHeader() {
    return (
        <div className="w-full h-10 bg-secondary text-sm text-white px-4 flex items-center">
      ...
      <button
        ...
        className="hidden md:inline-flex items-center h-8 px-2 border border-transparent hover:border-red-600 hover:text-red-400 text-yellow cursor-pointer duration-300"
      >
        Sign Out
      </button>
    )} */}
